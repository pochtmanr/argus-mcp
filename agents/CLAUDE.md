...
- **Automations**: `argus_list_automations`, `argus_automation_schema`, `argus_get_automation`, `argus_create_automation`, `argus_update_automation`, `argus_delete_automation`, `argus_run_automation`, `argus_automation_runs`, `argus_search_automations`, `argus_automation_summary`
