...
| Path | What it is |
| --- | --- |
| [`docs/api-reference.md`](./docs/api-reference.md) | All 126 endpoints and 136 tools — paths, fields, curl examples, status codes. |
...
and the 136 tools appear on their own.
