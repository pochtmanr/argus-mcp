...
| Path | What it is |
| --- | --- |
| [`docs/api-reference.md`](./docs/api-reference.md) | All 124 endpoints and 134 tools — paths, fields, curl examples, status codes. |
...
and the 134 tools appear on their own.
